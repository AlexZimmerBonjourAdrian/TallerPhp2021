...
class ShareModel extends Model{
	...
	/*if($post['submit']){
	{
		...
		*/
		...
		if(isset($_SESSION['cliente_data']['id']) !== isset($_SESSION['suscripcion_data']['idcli']) || isset($_SESSION['suscripcion_data']['tipoPlan']) !== isset($_SESSION['recurso_data']['tipoPlan'])) 
			{
				...
				else if(isset($_SESSION['recurso_data']['tipoPlan']) === 'Gold'  &&  (($_SESSION['suscripcion_data']['tipoPlan']) === 'Free' || $_SESSION['suscripcion_data']['tipoPlan'] === 'Silver') )
				{
					header('Location: '.ROOT_URL.'users/suscripcion');
				}
