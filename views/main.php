            ...
            <div class="container-fluid">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    ...
                    <!-- Si esta log -->
                    <li><a href="<?php echo ROOT_URL; ?>">Welcome <?php echo $_SESSION['autor_data']['name']; ?></a></li>
                    <div class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" style="background: #e78200;"> <img class="dropdown-image" src="assets/img/avatar.jpg?h=e3b60751fd03f37b89a9c1114bc263a4"></a>
